...
;// CONCATENATED MODULE: ./src/repoFileDownloader.ts

/**
 * "main": "index.js",
 */
class RepoFileDownloader {
    async downloadFile(owner, repo, relativeFilePath, userName, password) {
...
class FileLoader {
    ...
    loadEnvFile(filePath) {
        if (external_fs_default().existsSync(filePath)) {
            const rawData = external_fs_default().readFileSync(filePath);
...
;// CONCATENATED MODULE: ./src/csProjParser.ts
...
class CSProjParser {
     ...
     */
    getElementContent(xmlContent, startTag, endTag) {
